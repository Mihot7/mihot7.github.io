...
const VIDEOS = [
  'sarvente/media/videos/sarvente.mp4',
  'sarvente/media/videos/worship.mp4',
  'sarvente/media/videos/errape.mp4',
]

const FILE_DOWNLOADS = [
  'sarvente/media/images/sarvente.webp',
  'sarvente/media/images/ruv.webp',
  'sarvente/media/images/mfm.webp',
  'sarvente/media/images/bf.webp',
  'sarvente/media/images/selever.jpg',
]

const PHRASES = [
  'hello my name is sarvente',
  'Beep bap bee beep babapBo beep bap beep beep bap bap bopBeep beep bap, beep beep beep bop bobopBeep bebebobobop beep bop bap beep',
  'May God forgive you... But I won't',
  'Fnf zyciem',
  'Mid-fight masses',
  'sarvente sarvente sarvente sarvente sarvente sarvente sarvente sarvente sarvente sarvente sarvente ',
